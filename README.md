...
- [nix-community/nur-packages-template](https://github.com/nix-community/nur-packages-template) (3 days ago) - A template for NUR repositories: [maintainer=@fgaz] 
- [Pandapip1/nixos](https://github.com/Pandapip1/nixos) (6 days ago) - My nixos configuration files; GitHub mirror
- [LudovicRousseau/CCID](https://github.com/LudovicRousseau/CCID) (1 week ago) - CCID driver
- [notify-rs/notify](https://github.com/notify-rs/notify) (2 weeks ago) - 🔭 Cross-platform filesystem notification library for Rust. 
